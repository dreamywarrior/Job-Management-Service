...
jobs_data = [
    ...
    {
        "title": "Remote Chat Support Agent",
        "company": "Confidential",
        "description": "Work from home answering chats. Immediate hiring. Pay starts at $4,800 weekly. Send your bank details after onboarding.",
        "location": "Remote",
        "department": "Support",
        "salary_range": "$4,800/week",
        "company_profile": "",
        "requirements": "No experience required. Must be available today.",
        "benefits": "Fast pay, flexible schedule.",
        "telecommuting": True,
        "has_company_logo": False,
        "has_questions": False,
        "employment_type": "Contract",
        ...
        "function": "Support",
        "application_deadline": now + timedelta(hours=6),
        "job_link": "https://example.com/jobs/remote-chat-support-agent",
    },
    {
        "title": "Cash App Processor",
        "company": "Private Recruiter",
        "description": "Transfer money for our clients using your personal account. No office required. Urgent position, apply now and receive payment today.",
        "location": "Remote",
        "department": "Finance",
        "salary_range": "$120/hour",
        "company_profile": "",
        "requirements": "Personal bank account, fast onboarding.",
        "benefits": "Daily pay, bonus for speed.",
        "telecommuting": True,
        "has_company_logo": False,
        "has_questions": False,
        ...
        "function": "Accounting",
        "application_deadline": now + timedelta(hours=12),
        "job_link": "https://example.com/jobs/cash-app-processor",
    },
    {
        "title": "Crypto Verification Specialist",
        "company": "CoinPay Support",
        "description": "Help verify crypto transactions from home. Deposit a small refundable amount to activate your seat. Telegram support only.",
        "location": "Remote",
        "department": "Operations",
        "salary_range": "$8,000/month",
        "company_profile": "",
        "requirements": "Crypto wallet, Telegram account, buy verification token.",
        "benefits": "Instant payouts, remote onboarding.",
        "telecommuting": True,
        "has_company_logo": False,
        "has_questions": False,
        "employment_type": "Contract",
        ...
        "function": "Operations",
        "application_deadline": now + timedelta(hours=18),
        "job_link": "https://example.com/jobs/crypto-verification-specialist",
    },
    {
        "title": "Online Survey Assistant",
        "company": "Survey Boosters",
        "description": "Earn money completing surveys. No interview. Submit a fee to unlock premium survey links and start earning immediately.",
        "location": "Remote",
        "department": "Marketing",
        "salary_range": "$2,500/week",
        "company_profile": "",
        "requirements": "Basic internet access. Upfront fee required.",
        "benefits": "Flexible work from anywhere.",
        "telecommuting": True,
        "has_company_logo": False,
        "has_questions": False,
        ...
        "job_link": "https://example.com/jobs/online-survey-assistant",
    },
    {
        "title": "Payroll Data Specialist",
        "company": "Confidential",
        "description": "Process payroll from home using your own wallet. We will send funds to you, then you forward them to contractors. Immediate start.",
        "location": "Remote",
        "department": "Payroll",
        "salary_range": "$6,000/week",
        "company_profile": "",
        "requirements": "Personal wallet, availability today, fast responses.",
        "benefits": "Weekly pay, no commute.",
        "telecommuting": True,
        "has_company_logo": False,
        "has_questions": False,
        "employment_type": "Temporary",
        ...
        "industry": "Administrative",
        "function": "Accounting",
        "application_deadline": now + timedelta(hours=4),
        "job_link": "https://example.com/jobs/payroll-data-specialist",
    },
    {
